...
/*   Updated: 2023/05/03 16:36:09 by jteoh            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	w(t_data *data)
{
	...
	{
		if (data->map[(data->sprite_y60 / 60) - 1][data->sprite_x60 / 60] == 'E'
			&& data->ccount != 0)
			return ;
		mlx_put_image_to_window(data->mlx_ptr, data->win_ptr,
			data->sprite_ptr, data->sprite_x60, data->sprite_y60 - 60);
		mlx_put_image_to_window(data->mlx_ptr, data->win_ptr,
...
void	a(t_data *data)
{
	...
	{
		if (data->map[data->sprite_y60 / 60][(data->sprite_x60 / 60) - 1] == 'E'
			&& data->ccount != 0)
			return ;
		mlx_put_image_to_window(data->mlx_ptr, data->win_ptr,
			data->sprite_ptr, data->sprite_x60 - 60, data->sprite_y60);
		mlx_put_image_to_window(data->mlx_ptr, data->win_ptr,
			data->floor_ptr, data->sprite_x60, data->sprite_y60);
		data->sprite_x60 -= 60;
	}
